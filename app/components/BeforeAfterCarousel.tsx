...
// Données des projets de rénovation avec avant/après
const renovationProjects = [
  {
    id: 1,
    title: "Ravalement de façade - Immeuble Haussmannien",
    location: "Paris 8ème",
    beforeImage: "./assets/images/b1.jpeg?height=600&width=800",
    afterImage: "./assets/images/b2.jpeg?height=600&width=800",
    description:
      "Restauration complète d'une façade haussmannienne avec nettoyage, réparation des moulures et application d'un enduit à la chaux.",
  },
  {
    id: 2,
    ...
    description:
      "Isolation thermique par l'extérieur avec enduit décoratif et amélioration de la performance énergétique.",
  },
  {
    id: 3,
    title: "Rénovation complète de façade",
    location: "Marseille",
    beforeImage: "./assets/images/c1.jpeg?height=600&width=800",
    afterImage: "./assets/images/c2.jpeg?height=600&width=800",
    description: "Traitement des fissures, application d'un revêtement imperméabilisant et peinture décorative.",
  },
  {
    id: 4,
    ...
    description: "Application d'une peinture façade haute durabilité avec protection contre les UV et les intempéries.",
  },
  {
    id: 5,
...
export default function BeforeAfterCarousel() {
  ...
  // Gérer l'autoscroll avec prise en compte du hover
  useEffect(() => {
    if (!isHovering) {
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* Carousel - Layout modifié avec description à gauche et image à droite */}
              ...
              >
                ...
                <div className="w-full md:w-1/3 p-10 flex items-center bg-gradient-to-br from-gray-900 to-gray-800">
                  <div className="w-full">
                    <span className="text-emerald-400 font-semibold text-sm mb-3 inline-block uppercase tracking-wider">
                      {currentProject.location}
                    </span>
                    <h3 className="text-3xl font-bold text-white mb-5 leading-tight">{currentProject.title}</h3>
                    <div className="h-1 w-24 bg-emerald-500 mb-8 rounded-full"></div>
                ...
                >
                  ...
                  {/* Bouton Avant/Après sur l'image */}
                  <div className="absolute bottom-8 right-8 z-10">
                    <button
                      onClick={() => setIsBeforeView(!isBeforeView)}
                      className="bg-emerald-500 hover:bg-emerald-600 text-white px-6 py-3 rounded-full text-sm font-medium shadow-xl transition-all duration-300 hover:scale-105 backdrop-blur-sm"
                    >
